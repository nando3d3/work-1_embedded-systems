...
class ModelConfig:
    ...
    def config_server1(self):
        host = self.file["host_server_1"]
        port = self.file["port_server_1"]
        host_central = self.file["host_central"]
        port_central = self.file["port_central"]
        
        jsons_outputs1 = self.file["outputs_1"]       
        jsons_inputs1 = self.file["inputs_1"]

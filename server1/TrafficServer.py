...
class TrafficServer(threading.Thread):
    def __init__(self):
        super().__init__()
        self.host, self.port, self.host_central, self.port_central, self.pins_output, self.pins_input = ModelConfig('../modelconfig/config.json').config_server1()
    ...
    def run(self):
        ...
        try:
            ...
            self.connection.send_message('servidor 1 encerrado!')
